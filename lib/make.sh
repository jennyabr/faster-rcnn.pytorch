...
# compile NMS
cd model/meta_architecture/nms/src
...
# compile roi_pooling
cd ../../
cd meta_architecture/roi_poolers/roi_pooling/src
...
# compile roi_align
cd ../../../
cd meta_architecture/roi_poolers/roi_align/src
...
# compile roi_crop
cd ../../../
cd meta_architecture/roi_poolers/roi_crop/src
